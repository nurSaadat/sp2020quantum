...
def drawGraph(architecture, mapping, diameter=20):
    ...
    if architecture == 'ibmq_armonk':
        # draw one node
        core.draw_circle('drawing1', [start_x, start_y], diameter, color_orange, fill=color_orange)
        core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], mapping[0], color=color_black, size=diameter)
    ...
    ###
        ...
        for k in range(num_of_nodes):
            if k in mapping.keys():
                core.draw_circle('drawing1', [start_x, start_y], diameter, color_orange, fill=color_orange)
                core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], mapping[k], color=color_black, size=diameter)
            else:
                core.draw_circle('drawing1', [start_x, start_y], diameter, color_white, fill=color_white)
                core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], str(k), color=color_blue, size=diameter)
            # draw an edge only if it is not the last node 
            if k < 4:
                core.draw_line("drawing1", [start_x + diameter, start_y], [start_x + (diameter * 2), start_y], color_white, line_width)
                start_x += diameter * 3
        ...
        for k in range(num_of_nodes):        
            if k == 2:
                ...
                if k in mapping.keys():
                    ...
                    core.draw_circle('drawing1', [start_x, start_y], diameter, color_white, fill=color_white)
                    core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], str(k), color=color_blue, size=diameter)
                core.draw_line("drawing1", [start_x, start_y + diameter], [start_x, start_y + (diameter * 2)], color_white, line_width)
                # restore coordinates 
    ...
    ###
        ...
        if k in mapping.keys():
            ...
            core.draw_circle('drawing1', [start_x, start_y], diameter, color_white, fill=color_white)
            core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], str(k), color=color_blue, size=diameter)
        core.draw_line("drawing1", [start_x + (diameter / 2) + 5, start_y - (diameter / 2) - 5], [start_x + (diameter * 2), start_y - (diameter * 1.5)], color_white, line_width)
        core.draw_line("drawing1", [start_x + (diameter / 2) + 5, start_y + (diameter / 2) + 5], [start_x + (diameter * 2), start_y + (diameter * 1.5)], color_white, line_width)
        core.draw_line("drawing1", [start_x - (diameter / 2) - 5, start_y - (diameter / 2) - 5], [start_x - (diameter * 2), start_y - (diameter * 1.5)], color_white, line_width)
        core.draw_line("drawing1", [start_x - (diameter / 2) - 5, start_y + (diameter / 2) + 5], [start_x - (diameter * 2), start_y + (diameter * 1.5)], color_white, line_width)
        k += 1
    ...
    ###
        ...
        for k in range(num_of_nodes):
            ...
            if temp_key in mapping.keys():
                core.draw_circle('drawing1', [start_x, start_y], diameter, color_orange, fill=color_orange)
                temp_key = num_of_nodes - (k + 1)
                core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], mapping[temp_key], color=color_black, size=diameter)
            else: 
                core.draw_circle('drawing1', [start_x, start_y], diameter, color_white, fill=color_white)
                core.draw_text('drawing1', [start_x - (diameter / 2), start_y + (diameter / 2)], str(temp_key), color=color_blue, size=diameter)
